...
namespace web.Controllers
{
    public class InventoryController : Controller
    {
        ...
        public InventoryController(FlatmatesContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("itemID,householdID,categoryName,itemName,essential")] Inventory inventory)
        {
