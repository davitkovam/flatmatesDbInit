...
namespace web.Controllers
{
    public class HouseholdsController : Controller
    {
        ...
        public HouseholdsController(FlatmatesContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("householdID,address,code,description")] Household household)
        {
